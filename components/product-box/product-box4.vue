    ...
    <div class="img-wrapper">
        ...
        <div class="front text-center">
            <nuxt-link :to="{ path: '/product/'+product.id}">
                <img :src='getImgUrl(product.product_images[0].image)' :id="product.id" v-if="product.product_images && product.product_images.length" class="img-fluid bg-img" :alt="product.name" :key="index" />
            </nuxt-link>
        </div>
        <div class="back">
            <nuxt-link :to="{ path: '/product/'+product.id}">
