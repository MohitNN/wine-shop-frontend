            ...
            <ul class="list">
              <li class="clearfix">
                <img
                  ...
                  src="../../assets/admin/images/dashboard/user.png"
                  alt=""
                />
              ...
              <li class="clearfix">
                <img
                  class="rounded-circle user-image"
                  src="../../assets/admin/images/dashboard/user1.jpg"
                  alt=""
                />
              ...
              <li class="clearfix">
                <img
                  class="rounded-circle user-image"
                  src="../../assets/admin/images/dashboard/user2.jpg"
                  alt=""
                />
                <div class="status-circle online"></div>
                <div class="about">
              ...
              <li class="clearfix">
                <img
                  class="rounded-circle user-image"
                  src="../../assets/admin/images/dashboard/user3.jpg"
                  alt=""
                />
                <div class="status-circle online"></div>
                <div class="about">
              ...
              <li class="clearfix">
                <img
                  class="rounded-circle user-image"
                  src="../../assets/admin/images/dashboard/user5.jpg"
                  alt=""
                />
                <div class="status-circle away"></div>
                <div class="about">
              ...
              <li class="clearfix">
                <img
                  class="rounded-circle user-image"
                  src="../../assets/admin/images/dashboard/designer.jpg"
                  alt=""
                />
                <div class="status-circle online"></div>
                <div class="about">
...
export default {
  data() {
    return {
      chatSidebar: false,
      imageUrl: "@/assets/admin/images/dashboard/"
    };
  },
  computed: {
    toggleChatSidebar() {
