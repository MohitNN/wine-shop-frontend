    ...
    <div class="collection-filter" :class="{ openFilterbar: filter }">
      ...
      <div class="collection-filter-block">
        ...
        <div class="collection-collapse-block open" v-if="categories.length">
          <div class="mobile-back text-right" @click="filter = !filter">
              <span>Back</span>
            ...
            <div class="collection-collapse-block-content">
              <div class="collection-brand-filter">
                ...
                >
                  ...
                  <label
                    class="custom-control-label"
                    v-bind:for="'category' + category.id"
                    >{{ category.name }}</label
                  >
                </div>
              </div>
        ...
        <div class="collection-collapse-block open" v-if="subCategories.length">
          <h3 class="collapse-block-title" v-b-toggle.subcategory>
            Sub Category
          </h3>
          <b-collapse
            id="subcategory"
            ...
            <div class="collection-collapse-block-content">
              <div class="collection-brand-filter">
                ...
                >
                  ...
                  <label
                    class="custom-control-label"
                    v-bind:for="'subcategory' + category.id"
                    >{{ category.name }}</label
                  >
                </div>
              </div>
