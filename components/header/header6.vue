                                ...
                                <ul class="header-dropdown">
                                    ...
                                    <li class="onhover-dropdown mobile-account">
                                        ...
                                        <ul class="onhover-show-div">
                                            <li>
                                                <nuxt-link :to="{ path: '/page/account/login' }">Login</nuxt-link>
                                            </li>
                                            <li>
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div>
                                                <img :src='"@/assets/images/jewellery/icon/search.png"' @click="openSearch()" class="img-fluid" alt />
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <form>
                                                                        <div class="form-group mb-0">
                                                                            <input type="text" class="form-control" v-model="searchString" @keyup="searchProduct" placeholder="Search a Product">
                                                                        </div>
