                  ...
                  <div class="add-product">
                    <div class="row">
                      ...
                      >
                        ...
                        <img
                          :src="imageUrlSet + products.product_images[0].image"
                          v-if="products.product_images && products.product_images.length"
                          id="sawImg"
                          class="img-fluid image_zoom_1 blur-up lazyloaded"
                        />
                        <img
                          src="@/assets/images/imgPerview.png"
                          v-else
                          id="sawImg"
                          class="img-fluid image_zoom_1 blur-up lazyloaded"
                        />
                        ...
                        >
                          <div class="form-group row">
                            ...
                            <v-select
                              ...
                              class="col-xl-8 col-sm-7 pr-0 pl-0"
                              :options="brand"
                              name="brand"
                              label="name"
                              :reduce="(c) => c.id"
...
export default {
  ...
  methods: {
    ...
    createImage(file) {
      var reader = new FileReader();
      reader.onload = (e) => {
        this.products.product_images.push({image:e.target.result});
      };
