                            ...
                            <b-card-text>
                                <div class="dashboard-right">
                                    <div class="dashboard">
                                        ...
                                        <div class="form-group mb-3 row align-items-baseline">
                                            <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Current Password :</label>
                                            <input class="form-control col-xl-5 col-sm-7" id="validationCustom01" type="text" required="" />
                                        </div>
                                        <div class="form-group mb-3 row align-items-baseline">
                                            <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Reset Password :</label>
                                            <input class="form-control col-xl-5 col-sm-7" id="validationCustom01" type="text" required="" />
                                        </div>
                                        <div class="form-group mb-3 row align-items-baseline">
                                            <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Confirm Password :</label>
                                            <input class="form-control col-xl-5 col-sm-7" id="validationCustom01" type="text" required="" />
                                        </div>
